...
export default function App() {
  ...
  // Activity & Todo Component State (Lifted for passing down)
  ...
  if (!user || isAuthLoading) {
    return <Login isAuthLoading={isAuthLoading} isLoginMode={isLoginMode} setIsLoginMode={setIsLoginMode} handleAuthSubmit={handleAuthSubmit} authError={authError} setAuthError={setAuthError} email={email} setEmail={setEmail} password={password} setPassword={setPassword} />;
  }
